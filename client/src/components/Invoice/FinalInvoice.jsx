...
function FinalInvoice() {
  ...
  <div className="w-full px-2 mt-4">
    <div className="grid grid-cols-12 gap-2">
      ...
      <div className="col-span-12 lg:col-span-3">
      <Link  to="/invoicelist"> <button
         
          className="text-white text-decoration-none bg-green-600 hover:bg-green-700 font-bold py-2 px-4 rounded w-full"
        >
         Invoice List
        </button></Link> 
      </div>
        ...
        <table className="table-auto w-full border-collapse border border-gray-200">
          <thead>
            <tr className="bg-gray-100">
              ...
              <th className="border border-gray-200 px-4 py-2">Service Name</th>
              <th className="border border-gray-200 px-4 py-2">Actual Price (INR)</th>
              <th className="border border-gray-200 px-4 py-2">Offer Price (INR)</th>
          ...
          <tbody>
            {filterServicesByType("Paid").map((q, index) => (
              <tr key={q.id}>
                ...
                <td className="border border-gray-200 px-4 py-2">{q.actual_price}</td>
                <td className="border border-gray-200 px-4 py-2">{q.offer_price}</td>
                <td className="border border-gray-200 px-4 py-2">{q.subscription_frequency}</td>
